...
<head>
    ...
    <script>
        ...
        ngApp.controller("myCtl", function($scope) {
            $scope.project = {
            ...
            $scope.reset = function(){$scope.project = angular.copy($scope.initialPro);};
        });
        ...
        <div class="page-content-wrapper">
            <div class="page-content-wrapper">
                <div class="page-content">
                    <h5 class="page-title">项目详情</h5>
                    <hr/>
                    <div class="panel-group" ng-app="myApp" ng-controller="myCtl" id="panel-group">
                                ...
                                <div class="panel-body tab-content ">
                                    <div id="collapseOne_1" class="tab-pane active fade in">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="checkbox" disabled name="project.projectType" value="已签订合同" ${(project.projectType=='已签订合同' )?string( 'checked', '')} />已签订合同

                                            <input type="checkbox" disabled name="project.projectType" value="库存储备项目" ${(project.projectType=='库存储备项目' )?string( 'checked', '')} />库存储备项目

                                            <input type="checkbox" disabled name="project.projectType" value="科研项目" ${(project.projectType=='科研项目' )?string( 'checked', '')}/>科研项目

                                            <input type="checkbox" disabled name="project.projectType" value="虚拟项目" ${(project.projectType=='虚拟项目' )?string( 'checked', '')} />虚拟项目
                                    ...
                                    <div id="collapseOne_2" class="tab-pane fade form-body">
                                        <form id="form_basic" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="project.customerName" ng-model="project.customerName" value="${project.customerName}" class="form-control input-xlarge" />
                                                </div>
                                            </div>
