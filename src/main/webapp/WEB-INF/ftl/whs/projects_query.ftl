              ...
              <div id="filtersMenu515149187" class="yuimenu">
                <div class="bd">
                  <ul>
                    ...
                    <li class="yuimenuitem "><span class="yuimenubaritemlevel2"><table><tr><td style="padding-right: 10px;"><input class="ProjectsStatusFilters toggle" name="ProjectsStatus1" id="ProjectsStatus1" value="1"  type="checkbox"></td><td><a href="#">设计中</a></td></table></span></li>
                    ...
                    <li class="yuimenuitem "><span class="yuimenubaritemlevel2"><form id="filter_by_ProjectsStatus_form" action="/qdPM_9/index.php/projects" method="post"><input type="hidden" name="filter_by[ProjectsStatus]" value="" id="filter_by_ProjectsStatus" /><table onClick="filter_by_selected('ProjectsStatus','')"><tr><td style="padding-right: 10px;"><img src="/images/icons/arrow_up.png" /></td><td>按选择项筛选</td></table></form></span></li>
              ...
              <div id="filtersMenu738489150" class="yuimenu">
                <div class="bd">
                  <ul>
                    ...
                    <li class="yuimenuitem "><span class="yuimenubaritemlevel2"><form id="filter_by_Users_form" action="/qdPM_9/index.php/projects" method="post"><input type="hidden" name="filter_by[Users]" value="" id="filter_by_Users" /><table onClick="filter_by_selected('Users','')"><tr><td style="padding-right: 10px;"><img src="/images/icons/arrow_up.png" /></td><td>按选择项筛选</td></table></form></span></li>
              ...
              <div id="filtersMenuProjectsStatus1247404242" class="yuimenu">
                <div class="bd">
                  <ul>
                    ...
                    <li class="yuimenuitem "><span class="yuimenubaritemlevel1"><table><tr><td style="padding-right: 10px;"><input class="ProjectsStatusFiltersPreview toggle" name="ProjectsStatus1" id="ProjectsStatus1" value="1" checked="checked" type="checkbox"></td><td><a href="#">设计中</a></td></table></span></li>
                    ...
                    <li class="yuimenuitem "><span class="yuimenubaritemlevel1"><form id="filter_by_ProjectsStatus_form" action="/qdPM_9/index.php/projects" method="post"><input type="hidden" name="filter_by[ProjectsStatus]" value="" id="filter_by_ProjectsStatus" /><table onClick="filter_by_selected('ProjectsStatus','Preview')"><tr><td style="padding-right: 10px;"><img src="/images/icons/arrow_up.png" /></td><td>按选择项筛选</td></table></form></span></li>
                  ...
                  <td valign="middle" class="selectedFilterItems">设计中</td>
            ...
            <div class="filterPreviewBox">
              <table style=“width:100%”>
                ...
                发货日期：
                  ...
                  <td valign="middle" class="selectedFilterItems">2018年8月1日</td>
          ...
          <td>
            <table>
              <tr>
                          ...
                          <button class="btn btn-primary"><i class="fa fa-search"></i> 搜素</button>
            </td>
          ...
          <td align="right">
            <table>
              <tr>
                ...
                <li class="yuimenubaritem "><span class="yuimenubaritemlevel0">导出</span>
                <div id="with_selected_menu66421841599211560" class="yuimenu">
                <div class="bd">
                <ul>

                <li class="yuimenuitem" onClick="openMultipleActionModalBox('/qdPM_9/index.php/projects/multipleEdit')"><span>Excel</span></li>

                <li class="yuimenuitem" onClick="openMultipleActionModalBox('/qdPM_9/index.php/projects/export')"><span>PDF</span></li>
                </ul>
                </div>
                </div></li>
