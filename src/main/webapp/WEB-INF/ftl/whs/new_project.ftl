                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group input-medium">
                                                <input type="text" name="project.assuranceBegin" value="" class="form-control" /></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group input-medium">
                                              ...
                                              <input type="text" name="project.assuranceDuration" value="" class="form-control" /></div>

                                              <!--
                                                <select name="project.assuranceDuration" id="assuranceDuration">
