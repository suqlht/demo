...
<head>
    ...
    <title>
        <@spring.message "system.title"/> | 项目管理
    </title>
                ...
                <form class="form-horizontal" role="form" id="form_projects" action="${rc.contextPath}/projects/whs/new_project" method="post">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a id="tab1" href="#tab_1" data-toggle="tab">基本信息</a>
                            </li>
                            <li>
                                <a id="tab2" href="#tab_2" data-toggle="tab">供货范围</a>
                            </li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active fade in" id="tab_1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control input-medium required autofocus" type="text" name="project.projectCode" onchange="changeProjectCode(this)" value="" />
                                        <input type="checkbox" name="project.projectType" value="已签订合同" checked/>已签订合同

                                        <input type="checkbox" name="project.projectType" value="库存储备项目" />库存储备项目

                                        <input type="checkbox" name="project.projectType" value="科研项目" />科研项目

                                        <input type="checkbox" name="project.projectType" value="虚拟项目" />虚拟项目
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="project.customerName" value="" class="form-control input-xlarge" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-medium date datepicker">
                                            <input type="text" name="project.deliveryDate" value="" class="form-control" /><span class="input-group-btn"><button class="btn btn-default date-set" type="button"><i class="fa fa-calendar"></i></button></span></div>
                                    </div>
                                </div>

                                <input type="hidden" name="project.assuranceBegin2" value="">

                                <div class="form-group">
                                    <label class="col-md-3 control-label"><span class="required">*</span>质保期生效时间</label>
                                    <div class="col-md-6">
                                        <input type="text" name="project.assuranceBegin" value="" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="project.assuranceDuration" value="" class="form-control" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="project.assuranceRemark" value="" class="form-control input-xlarge" />
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group  input-large">
                                    <span class="input-group-addon" id="linkto_project_id"></span>
...
<script>
    ...
    function getPostData() {
        ...
        dataTable.data().each(function(d) {
            postData.subprojects.push({
                subProjectId: postData.project.projectCode + '-' + d.subProjectId,
    ...
    function save_new_project() {
        ...
        $.ajax({
            url: '${rc.contextPath}/projects/create',
    ...
    jQuery(document).ready(function() {
        ...
        function succFunction(tt) {
            ...
            $('#device_types_id').select2({
                language: {
                    noResults: function() {
                        return '额定工时库无此设备，请到额定工时库添加后再操作。';
                    }
                },
                data: device_options,
    ...
    function changeProjectCode(target) {
        $('#linkto_project_id').html($(target).val() + '-');
    }
        ...
        dataTable = $('#device_table').DataTable({
            ...
            columns: [{
                ...
                "render": function(data, type, row, meta) {
                    return $('[name="project.projectCode"]').val() + '-' + data;
                }
                ...
                data: null,
                "render": function(data, type, row, meta) {
                    return parseInt(row['totalElectricalHours']) + parseInt(row['totalMechanicalHours']);
                }
            }, {
                data: "remark"
            }],
    ...
    function generateNewDevice() {
        ...
        new_device.subProjectId = $('#sub_project_id').val()
        new_device.deviceId = $('#device_types_id').val();
        new_device.model = ($('#new_device_model').val());
        new_device.spec = ($('#new_device_spec').val());
    ...
    function update_new_device() {
        ...
        data.model = new_device.model;
        data.spec = new_device.spec;
    ...
    function add_new_device() {
        ...
        dataTable.data().each(
            function(item) {
                console.log(item.subProjectId);
                if (item.subProjectId == new_device.subProjectId) {
                    exists++;
                }
            }
        );
    ...
    function open_modify_device() {
        if (dataTable.rows('.selected').data().length != 1) {
            ...
            $('#sub_project_id').val(data.subProjectId);
