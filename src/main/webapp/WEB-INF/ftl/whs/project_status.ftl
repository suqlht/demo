...
<div class="form-group">
  <label class="sr-only" for="name">项目状态</label>
  <select id="project_status" class="" name="assurance_duration">
      <option value="">项目状态</option>

      <option value="1">正常</option>
      <option value="3">预计拖期</option>
      <option value="3">已拖期</option>
...
<br>
      ...
      <table class="table table-striped table-bordered table-hover projects-table" id="itmes_listing_4466081"   >
        <thead>
          <tr>
            ...
            <th colspan="3" class="text-center">机械设计部</th>
            <th colspan="3" class="text-center">电气设计部</th>
            <th colspan="2" class="text-center">采购</th>
            <th>油漆</th>
            <th colspan="2" class="text-center">质检</th>
            <th colspan="2" class="text-center">筑炉</th>
            <th colspan="9" class="text-center">车间生产装配</th>
            <th colspan="5" class="text-center">车间调试</th>
            <th rowspan="3">备注</th>
          </tr>
          <tr>
      ...
      var dataSet = [
        [
          "1","HM0100-01","","2018-05-30","2018-12-11","215","2018-12-21","2018-12-01","正常","","2018-12-31","2018-12-31","","2018-12-31","2018-12-31","",[['炉壳','2018/1/1','2018/1/1'],['辐射管','2018/1/1','2018/1/1'],['进口电机','2018/1/1','']],"","2018-12-31","2018-12-31","2018-12-31","2018-12-31","2018-12-31","2018-12-31","2018-12-31","2018-12-31","2018-12-31", "300","300","100","60","","2018-12-31","2018-12-31","2018-12-31","2018-12-31","",""
        ],
        [
          "1.01","HM0100-01","DHQ-3/3","2018-05-30","2018-12-11","215","2018-12-21","2018-12-01","正常","","2018-12-31","2018-12-31","","2018-12-31","2018-12-31","",[['炉壳','2018/1/1','2018/1/1'],['辐射管','2018/1/1','2018/1/1'],['进口电机','2018/1/1','']],"","2018-12-31","2018-12-31","2018-12-31","2018-12-31","2018-12-31","2018-12-31","2018-12-31","2018-12-31","2018-12-31", "300","300","100","60","","2018-12-31","2018-12-31","2018-12-31","2018-12-31","",""
        ]
      ]
