...
<@menu 1/>
    ...
    <!-- END SIDEBAR -->
      ...
      <ul class="nav nav-tabs">
      	<li>
          <a href="#tab_general" data-toggle="tab">项目信息</a>
        </li>

      	<li>
          <a href="#tab_devices" data-toggle="tab">设备信息</a>
        </li>
        <li class="active">
          <a href="#tab_groups" data-toggle="tab">班组人员</a>
        </li>
      </ul>
      </div>
