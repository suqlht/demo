...
<table>
 <tr>
             <td style="padding-right: 15px;"><button class="btn btn-primary" onClick="openModalBox('/qdPM_9/index.php/tasks/new/redirect_to/tasksList')">添加任务</button></td>

   <td style="padding-right: 15px;"><div id="tableListingMultipleActionsMenu">
 <div id="with_selected_menu4742872" class="yuimenubar yuimenubarnav" style="display: none">
   <div class="bd">
     <ul>

       <li class="yuimenubaritem "><span class="yuimenubaritemlevel0">将选择项</span>
 <div id="with_selected_menu4742872261031422" class="yuimenu">
   <div class="bd">
     <ul>

       <li class="yuimenuitem" onClick="openMultipleActionModalBox('/qdPM_9/index.php/tasks/multipleEdit/redirect_to/tasksList')"><span>更新</span></li>

       <li class="yuimenuitem" onClick="openMultipleActionModalBox('/qdPM_9/index.php/tasks/moveTo/redirect_to/tasksList')"><span>移到</span></li>

       <li class="yuimenuitem" onClick="openMultipleActionModalBox('/qdPM_9/index.php/tasks/export/redirect_to/tasksList')"><span>导出</span></li>
</ul><ul>
       <li class="yuimenuitem" onClick="openMultipleActionModalBox('/qdPM_9/index.php/app/multipleDelete/table/tasks/redirect_to/tasksList')"><span>删除</span></li>
...
<script type="text/javascript">
 YAHOO.util.Event.onContentReady("with_selected_menu4742872", function ()
 {
     var oMenuBar = new YAHOO.widget.MenuBar("with_selected_menu4742872", {
                                             autosubmenudisplay: true,
                                             hidedelay: 750,
                                             submenuhidedelay: 0,
                                             showdelay: 150,
 ...
 <div id="order_by_menu775974705" class="yuimenu">
   <div class="bd">
     <ul>
         ...
         <li class="yuimenuitem"><a  class="yuimenuitemlabel" href="/qdPM_9/index.php/tasks?set_order=status"  ><strong>状态</strong></a></li>
...
<table class="table table-striped table-bordered table-hover tasks-table" id="itmes_listing_4742872"  style="display:none" >
<thead>
<tr>
<th class="table-checkbox"  data-bSortable="false"><input class="group-checkable" data-set="# .checkboxes"  type="checkbox"></th>
     ...
     <th data-bsType="title-numeric"><div>优先次序</div></th>


     <th width="100%"><div>名称</div></th>
...
<th><div>分配给</div></th>
     ...
     <th data-bsType="title-numeric"><div>截止日期</div></th>
...
<tbody>
 <tr>
<td><input class="checkboxes" name="multiple_selected[]" id="multiple_selected_24" type="checkbox" value="24"></td>
     ...
     <td><span title="2"></span><img title="中" src="/images/icons/p/prio_3.png" /> 中</td>



<td>
 <a href="/qdPM_9/index.php/tasksComments?tasks_id=24&amp;projects_id=7">设计</a>
        </td>
...
<td>人员</td>
     ...
     <td><a href="#">pro1</a></td>
        <td><a class="btn btn-default btn-xs purple"  href="#"><i class="fa fa-trash-o"></i></a> <a href="#" class="btn btn-default btn-xs purple"><i class="fa fa-edit"></i></a></td>
   </tr>
 <tr>
<td><input class="checkboxes" name="multiple_selected[]" id="multiple_selected_23" type="checkbox" value="23"></td>
     ...
     <td><span title="2"></span><img title="Medum" src="/images/icons/p/prio_3.png" /> 中 </td>



<td>
 <a href="/qdPM_9/index.php/tasksComments?tasks_id=23&amp;projects_id=7">采购</a>
        </td>
...
<td>人员</td>
     ...
     <td><span title="1526572800"></span><b>5月 18, 2018 </b></td>
 ...
 <tr>
<td><input class="checkboxes" name="multiple_selected[]" id="multiple_selected_25" type="checkbox" value="25"></td>
...
<td>
 <a href="/qdPM_9/index.php/tasksComments?tasks_id=25&amp;projects_id=7">装配</a>
        </td>
...
<td>人员</td>
     ...
     <td><span title="1527177600"></span>5月 25, 2018 </td>
 ...
 <tr>
<td><input class="checkboxes" name="multiple_selected[]" id="multiple_selected_26" type="checkbox" value="26"></td>
...
<td>
 <a href="/qdPM_9/index.php/tasksComments?tasks_id=26&amp;projects_id=8">调试</a>
        </td>
...
<tr>
<td></td>
<td></td>      <td></td><td></td><td></td><td></td><td>760</td><td>500</td><td></td> <td></td><td></td> </tr>
</tfoot>
